...
## Features
- **Session-based Default**: Video playbacks default to 1.5x speed. YouTube default quality is 720p.
- **Dynamic UI Control**: A modern popup interface allowing you to switch between 0.5x, 1.0x, 1.5x, and 2.0x speeds, and Auto, 480p, 720p, and 1080p qualities.
...
## Usage
Once installed, any video you open will automatically play at 1.5x speed, and YouTube videos will launch in 720p. 
Click the extension icon in your Chrome toolbar to quickly adjust the speed and quality for the current session.
